// //Apostila Web Dev. Daniel Cintra -> Concatenação e Strings
// // Criação de strings
...
// Descrição: ${descricao}`;
// console.log("Template string:", resumo);
...
//Nesta aula, exploramos como manipular strings, realizar operações matemáticas e trabalhar com datas utilizando os objetos Math e Date do JavaScript. 
//Esses conhecimentos são fundamentais para o processamento de dados e para a criação de interfaces dinâmicas no TaskMaster.
//Os exercícios práticos permitiram aplicar os conceitos de busca, corte e formatação de textos, cálculos matemáticos (arredondamento, geração de números aleatórios e identificação de extremos) e manipulação de datas (formatação, cálculos e comparações). 
//Continue praticando para consolidar esses fundamentos, que serão essenciais para o desenvolvimento de aplicações mais avançadas.
